...
create index if not exists "ab_alpha_can_use__index" on Alpha_to_Beta (alpha_id, created_ts);

create index if not exists "ab_beta_can_use__index" on Alpha_to_Beta (beta_id, created_ts);
