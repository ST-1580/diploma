...
create index if not exists "gd_gamma_can_use__index" on Gamma_to_Delta (gamma_id, created_ts);

create index if not exists "gd_delta_can_use__index" on Gamma_to_Delta (delta_id, created_ts);
